...
handlers.index = function(data,callback){
  ...
  if(data.method == 'get'){
    ...
    var templateData = {
      'head.title' : 'Pure NodeJS HTTP Container Prototype',
      'head.description' : 'A framework for a pure NodeJS HTTP Server with API and MVC template implementations and a CLI interface for deployment.',
      'body.class' : 'index'
    };
